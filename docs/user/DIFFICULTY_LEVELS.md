...
- Если добавлено ≤1 точки за 50 попыток - расстояние снижается на 20%
- Максимум 3 снижения (до 51% от исходного расстояния)

| Уровень | Начальное minDist | После 3 снижений | Результат |
|---------|------------------|------------------|-----------|
| 🟢 Новичок | × 0.4 | × 0.20 | **100%** точек |
| 🟡 Любитель | × 0.8 | × 0.41 | **100%** точек |
| 🔴 Эксперт | × 1.2 | × 0.61 | **100%** точек |

### Как это работает

```
Попытка 1-50:   minDist = 300м (исходное), добавлено 2 точки
Попытка 51-100: minDist = 300м (без изменений), добавлено 1 точка
Попытка 101-150: minDist = 240м (-20%)  ⚠️ Снижение шаг 1, добавлено 0 точек
Попытка 151-200: minDist = 180м (-40%)  ⚠️ Снижение шаг 2, добавлено 1 точку
Попытка 201-250: minDist = 153м (-49%)  ⚠️ Снижение шаг 3
```
